...
public class AllocationValidator {
    ...
    private void validateDates(OffsetDateTime startAt, OffsetDateTime endAt, ValidationErrors validationErrors) {
        if (validateIfDatesArePresent(startAt, endAt, validationErrors)) {
            validateDateSequence(startAt, endAt, validationErrors);
            validateDateInTheFuture(startAt, validationErrors);
            validateAllocationDuration(startAt, endAt, validationErrors);
            validateIfTimeIsAvailable(startAt, endAt, validationErrors);
        }
    }

    private boolean validateIfDatesArePresent(OffsetDateTime startAt, OffsetDateTime endAt, ValidationErrors validationErrors) {
        return (
    ...
    private void validateDateSequence(OffsetDateTime startAt, OffsetDateTime endAt, ValidationErrors validationErrors) {
    ...
    private void validateAllocationDuration(OffsetDateTime startAt, OffsetDateTime endAt, ValidationErrors validationErrors) {
